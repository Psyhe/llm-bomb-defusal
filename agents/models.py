...
class SmollLLM(HFModel):
    ...
    # ) -> str:
    #     """
    #     Generates a text response given a list of chat-style messages.
    ...
    #     :param kwargs: Extra arguments for model.generate().
    #     :return: The generated response as a string.
    #     """
    #     # Format input with assistant prompt using chat template
    #     input_text: str = self.tokenizer.apply_chat_template(
    #         messages,
    #         tokenize=False,
